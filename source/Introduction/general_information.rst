...
as part of greater assignment on environmental monitoring. 
...
`Regional Centre for Mapping of Resource for Development (RCMRD) <https://www.rcmrd.org/>`_, who are the lead centre who imaplemnst GMES & Africa projects.
You can also reach out to LocateIT Limited, who were the consultants who developed the system through
`info@locateit.com` or `vivianne.meta@locateit.co.ke`.

Authors
--------------
LaSWE system was implemented as a patnership between RCMRD under the Global Monitoring for Environment and Security & Africa(GMES & Africa)
...
.. note::
   ...
   imply official endorsement or acceptance by RCMRD, LocateIT Limited, or its partnering 
   organizations.
